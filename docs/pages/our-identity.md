---
layout: default
title: Our Identity - selfdriven Health
...
- Prefer **short sentences** with occasional **long synthesis sentences**.
- Use **plain English first**, then technical precision.
- Avoid marketing fluff. Replace with **mechanisms**.
- Use active verbs: **build, convene, prove, govern, deploy, reduce, coordinate, scale**.
- When discussing AI: always include a boundary phrase:
  - **“AI assists; clinicians decide; people consent.”**

### Words we use (preferred vocabulary)

#### Trust / Governance
- trust infrastructure, assurance, safety case, auditability, verifiable evidence, provenance, consent, permissions, accountability, registry, policy

#### Identity (SSI)
- SSI, verifiable credentials, decentralised identifiers (DIDs), portable identity, selective disclosure, data minimisation, zero trust (contextual), proof

#### AI
- decision support, coordination layer, clinical copilot, workflow intelligence, triage assist, summarisation, risk signals, monitoring

#### Robotics
- repeatability, sterile tasks, logistics automation, throughput, reliability, physical infrastructure

#### System framing
- operating model, operating system, ecosystem, composable services, interoperability, outcomes

### Words we avoid (or use sparingly)
- “disrupt”, “revolutionise”, “game-changer”
- “magic”, “AI will replace”
- “seamless” (say **lower friction** instead)
- “blockchain solves” (say **verifiable infrastructure / proof layer**)
- “users” (prefer **people, patients, clinicians**)
...
- “AI assists; clinicians decide; people consent.”
- “Move from reactive treatment to prevention-first systems.”
